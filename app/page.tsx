      ...
      <section id="servicios" className="py-12 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-10 flex justify-center">
            ...
            >
              BAMP para tu negocio, todo lo que necesitas
            </a>
          </div>
        </div>
      </section>
          ...
          >
            ...
            <label className="flex flex-col gap-2">
              ...
              <input
                name="nombre"
                required
                className="bg-white/80 border border-white/80 text-slate-900 placeholder-white/70 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-300"
              />
            </label>
            ...
            <label className="flex flex-col gap-2">
              ...
              <textarea
                ...
                rows={5}
                required
                className="bg-white/80 border border-white/30 text-slate-900 placeholder-white/70 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-300"
              ></textarea>
            </label>
